...
/**
 * evergreen theme — built by `bunx astryx theme build`
...
export const evergreenTheme = {
  ...
  __built: true,
  tokens: {
    "--color-accent": "light-dark(#416918, #AAD37C)",
    "--color-accent-muted": "#bfd6a324",
    "--color-on-accent": "light-dark(#FFFFFF, #113900)",
    "--color-neutral": "light-dark(#191D141A, #DFE4D733)",
    "--color-background-surface": "#17211c",
    "--color-background-body": "#101a15",
    "--color-overlay": "light-dark(#191D1466, #191D1499)",
    "--color-overlay-hover": "light-dark(#191D140D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#191D141A, #FFFFFF1A)",
    "--color-background-muted": "#213028",
    "--color-text-primary": "light-dark(#191D14, #DFE4D7)",
    "--color-text-secondary": "light-dark(#42493A, #A6AE9C)",
    "--color-text-disabled": "light-dark(#8C9382, #5A6151)",
    "--color-text-accent": "var(--color-accent)",
    "--color-icon-accent": "var(--color-accent)",
    "--color-icon-primary": "light-dark(#191D14, #DFE4D7)",
    "--color-icon-secondary": "light-dark(#42493A, #A6AE9C)",
    "--color-icon-disabled": "light-dark(#8C9382, #5A6151)",
    "--color-background-card": "#1a2620",
    "--color-background-popover": "#212f27",
    "--color-background-inverted": "light-dark(#191D14, #F9FEF1)",
    "--color-border": "#ffffff15",
    "--color-border-emphasized": "light-dark(#8C9382, #636A5B)",
    "--color-skeleton": "light-dark(#A6AE9C, #42493A)",
    "--color-track": "light-dark(#A6AE9C, #42493A)",
