 ...
 * Source: dashboard/themes/graphite.theme.ts
 * Command: astryx theme build dashboard/themes/graphite.theme.ts
...
export const graphiteTheme = {
  ...
  __built: true,
  tokens: {
    "--color-accent": "light-dark(#85530B, #FABA71)",
    "--color-accent-muted": "#e3a96824",
    "--color-on-accent": "light-dark(#FFFFFF, #502600)",
    "--color-neutral": "light-dark(#201B151A, #EAE1D933)",
    ...
    "--color-text-primary": "light-dark(#201B15, #EAE1D9)",
    "--color-text-secondary": "light-dark(#4F453B, #B6A99E)",
    "--color-text-disabled": "light-dark(#9B8F83, #675C52)",
    "--color-text-accent": "var(--color-accent)",
    "--color-icon-accent": "var(--color-accent)",
    "--color-icon-primary": "light-dark(#201B15, #EAE1D9)",
    "--color-icon-secondary": "light-dark(#4F453B, #B6A99E)",
    "--color-icon-disabled": "light-dark(#9B8F83, #675C52)",
    "--color-background-card": "#1d1f24",
    "--color-background-popover": "#24262c",
    "--color-background-inverted": "light-dark(#201B15, #FFFBF6)",
    "--color-border": "#ffffff14",
    "--color-border-emphasized": "light-dark(#9B8F83, #71665C)",
    "--color-skeleton": "light-dark(#B6A99E, #4F453B)",
    "--color-track": "light-dark(#B6A99E, #4F453B)",
